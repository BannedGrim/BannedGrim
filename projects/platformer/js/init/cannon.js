(function (window) {
    ...
    function init(game) {
        ...
        */
        ...
        createCannon("top", 550); // a cannon on the top of the screen, located at x = 450
        createCannon("left", 300, 1000); // a cannon on the left side of the screen, located at y = 300, with a 1 second delay (1000ms)
        createCannon("bottom", 650); // a cannon on the top of the screen, located at x = 450
        createCannon("right", 175, 2000); // a cannon on the left side of the screen, located at y = 300, with a 1 second delay (1000ms)
        createCannon("right", 600, 500); // a cannon on the left side of the screen, located at y = 300, with a 1 second delay (1000ms)
